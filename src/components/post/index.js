...
return (
  <Card>
    <article className="post">
      ...
      <section className={`post-interactions-container border-top ${comments.length ? 'border-bottom' : ''}`}>
      ...
      <section className="post-comments">
        {comments.map((comment) => (
          <Comment
            ...
            fullName={comment.user ? `${comment.user.firstName} ${comment.user.lastName}` : 'Unknown User'}
